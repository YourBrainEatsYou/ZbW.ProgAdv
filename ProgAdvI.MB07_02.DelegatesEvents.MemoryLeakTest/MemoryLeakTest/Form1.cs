...
namespace MemoryLeakTest
{
    public partial class Form1 : Form
    {
        ...
        private void OnSubscribeToShortlivedObjects(object sender, EventArgs e)
        {
            ...
            for (int n = 0; n < count; n++)
            {
                ...
                // shortlived erstellt eine Referenz auf this.
                // D.h. es zeigt nichts auf shortlived
        ...
        private void OnShortlivedEventSubscribersClick(object sender, EventArgs e)
        {
            ...
            for (int n = 0; n < count; n++)
            {
                // shortlived2 registriert sich bei this.TextChanged
                // d.h. this erstellt eine Referenz auf shortlived2
                var shortlived2 = new ShortLivedEventSubscriber(this, n);
                //this.TextChanged -= shortlived2.OnTextChanged;
            }
    ...
    public class ShortLivedEventSubscriber
    {
        ...
        private int zaehler;
        public ShortLivedEventSubscriber(Control c, int zaehler)
        {
            Interlocked.Increment(ref Count);
        ...
        public void OnTextChanged(object sender, EventArgs eventArgs)
        {
            LatestText = ((Control) sender).Text;
            Debug.WriteLine($"Object {zaehler}:" + LatestText);
        }
